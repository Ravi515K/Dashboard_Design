...
function Cards() {
  ...
  return (
    <div className='lg:w-[100%] '>
      <nav className='lg:w-[50%] flex justify-between  sm:text-center md:text-left    fixed top-0 p-[20px] bg-white z-40'>
        <div>
          <h1 className='text-xl font-bold'>Dashboard</h1>
          <p className='text-brown text-sm'>4th August 2023</p>
        </div>
        <div className=' '>
          <input type="text" placeholder='Search Page' className='border text-center rounded-full border-black w-[150px] h-[30px]' />
        </div>
      </nav>
